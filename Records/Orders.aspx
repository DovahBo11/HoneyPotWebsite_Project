        ...
        <div>
            <asp:MultiView ID="MultiView" runat="server">
                <asp:View ID="OrdersView" runat="server">
                    <asp:GridView ID="GridView1" runat="server" DataSourceID="OrdersSqlDataSource" AutoGenerateDeleteButton="True" AutoGenerateSelectButton="True" DataKeyNames="OrderID" AllowPaging="True" AutoGenerateColumns="False">
                            <Columns>
